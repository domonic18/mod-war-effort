...
DELETE FROM `creature_template` WHERE (`entry` = 15818);
...
(15818, 0, 0, 0, 0, 0, 15794, 0, 0, 0, 'Lieutenant General Nokhor', '', NULL, 0, 63, 63, 0, 370, 0, 4.8, 2.85714, 1, 1, 20, 1, 1, 0, 35, 2000, 2000, 1, 1, 1, 0, 2048, 0, 0, 0, 0, 0, 0, 10, 8, 15818, 0, 0, 0, 0, 0, 0, 'SmartAI', 0, 1, 300, 1, 1, 1, 0, 228, 1, 646659935, 0, 1, '', 12340);

DELETE FROM `creature_onkill_reputation` WHERE (`creature_id` = 15818);
INSERT INTO `creature_onkill_reputation` (`creature_id`, `RewOnKillRepFaction1`, `RewOnKillRepFaction2`, `MaxStanding1`, `IsTeamAward1`, `RewOnKillRepValue1`, `MaxStanding2`, `IsTeamAward2`, `RewOnKillRepValue2`, `TeamDependent`) VALUES
(15818, 910, 609, 7, 0, 200, 7, 0, 400, 0);

DELETE FROM `creature_template` WHERE (`entry` = 15758);
INSERT INTO `creature_template` (`entry`, `difficulty_entry_1`, `difficulty_entry_2`, `difficulty_entry_3`, `KillCredit1`, `KillCredit2`, `modelid1`, `modelid2`, `modelid3`, `modelid4`, `name`, `subname`, `IconName`, `gossip_menu_id`, `minlevel`, `maxlevel`, `exp`, `faction`, `npcflag`, `speed_walk`, `speed_run`, `speed_swim`, `speed_flight`, `detection_range`, `scale`, `rank`, `dmgschool`, `DamageModifier`, `BaseAttackTime`, `RangeAttackTime`, `BaseVariance`, `RangeVariance`, `unit_class`, `unit_flags`, `unit_flags2`, `dynamicflags`, `family`, `trainer_type`, `trainer_spell`, `trainer_class`, `trainer_race`, `type`, `type_flags`, `lootid`, `pickpocketloot`, `skinloot`, `PetSpellDataId`, `VehicleId`, `mingold`, `maxgold`, `AIName`, `MovementType`, `HoverHeight`, `HealthModifier`, `ManaModifier`, `ArmorModifier`, `ExperienceModifier`, `RacialLeader`, `movementId`, `RegenHealth`, `mechanic_immune_mask`, `spell_school_immune_mask`, `flags_extra`, `ScriptName`, `VerifiedBuild`) VALUES
(15758, 0, 0, 0, 0, 0, 15710, 0, 0, 0, 'Supreme Anubisath Warbringer', NULL, NULL, 0, 62, 62, 0, 370, 0, 1, 1.14286, 1, 1, 20, 1, 1, 0, 7.5, 2000, 2000, 1, 1, 1, 0, 2048, 0, 0, 0, 0, 0, 0, 10, 8, 15758, 0, 0, 0, 0, 16580, 23909, 'SmartAI', 0, 1, 40, 1, 1, 1, 0, 0, 1, 646657877, 0, 0, '', 12340);

DELETE FROM `creature_onkill_reputation` WHERE (`creature_id` = 15758);
INSERT INTO `creature_onkill_reputation` (`creature_id`, `RewOnKillRepFaction1`, `RewOnKillRepFaction2`, `MaxStanding1`, `IsTeamAward1`, `RewOnKillRepValue1`, `MaxStanding2`, `IsTeamAward2`, `RewOnKillRepValue2`, `TeamDependent`) VALUES
(15758, 910, 609, 7, 0, 10, 7, 0, 10, 0);